...
var createAddress = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee2(userId, addressData) {
    var recipientName, recipientEmail, recipientPhone, address, _addressData$isDefaul, isDefault, emailRegex, phoneRegex;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          recipientName = addressData.recipientName, recipientEmail = addressData.recipientEmail, recipientPhone = addressData.recipientPhone, address = addressData.address, _addressData$isDefaul = addressData.isDefault, isDefault = _addressData$isDefaul === void 0 ? false : _addressData$isDefaul; // Validate required fields
  ...
  var _ref3 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee3(userId) {
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _ref4 = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : {}, _ref4$page = _ref4.page, page = _ref4$page === void 0 ? 1 : _ref4$page, _ref4$limit = _ref4.limit, limit = _ref4$limit === void 0 ? 50 : _ref4$limit;
          offset = (page - 1) * limit;
          _context3.next = 4;
          return _models.Address.findAndCountAll({
            where: {
              userId: userId
            },
        ...
        case 4:
          _yield$Address$findAn = _context3.sent;
          count = _yield$Address$findAn.count;
          addresses = _yield$Address$findAn.rows;
...
var getAddressById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(addressId, userId) {
    var address;
...
var updateAddress = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee6(addressId, userId, addressData) {
    var recipientName, recipientEmail, recipientPhone, address, isDefault, emailRegex, phoneRegex;
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          recipientName = addressData.recipientName, recipientEmail = addressData.recipientEmail, recipientPhone = addressData.recipientPhone, address = addressData.address, isDefault = addressData.isDefault; // Validate email format if provided
          if (!recipientEmail) {
            _context6.next = 5;
            break;
          }
...
var deleteAddress = /*#__PURE__*/function () {
  var _ref8 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee8(addressId, userId) {
    return _regenerator["default"].wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return _mySQL["default"].transaction(/*#__PURE__*/function () {
            var _ref9 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee7(t) {
...
var setDefaultAddress = /*#__PURE__*/function () {
  var _ref10 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee10(addressId, userId) {
    return _regenerator["default"].wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _context10.next = 2;
          return _mySQL["default"].transaction(/*#__PURE__*/function () {
            var _ref11 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee9(t) {
              var address;
...
var getDefaultAddress = /*#__PURE__*/function () {
  var _ref12 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee11(userId) {
    var defaultAddress;
